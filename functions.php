 ...
 */
 function melodiemartin_theme_scripts() {
     wp_enqueue_style( 'melodiemartin', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'melodiemartin_theme_scripts' );
 ...
 // END STEP 2.9
    ...
    function melodiemartin_theme_init(){
    ...
    add_action( 'widgets_init', 'melodiemartin_widgets_init' );
